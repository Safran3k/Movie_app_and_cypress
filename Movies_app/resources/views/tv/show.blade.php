...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img class="w-64 md:w-96" src="{{ 'https://image.tmdb.org/t/p/w500/' . $tvshow['poster_path'] }}" alt="parasite">
            <div class="md:ml-24">
                ...
                @if ($tvshow['videos']['results'] != null)
                    <div class="mt-12 inline-block play-trailer">
                ...
                <div class="mt-12 inline-block">
                    <div
                        class="ml-6 flex inline-flex items-center bg-white text-gray-900 rounded font-semibold px-5 py-4 hover:bg-slate-300 transition ease-in-out duration-150 ">
                        <svg class="w-6 fill-current" viewBox="0 0 24 24">
                            <path
                    ...
                    @if ($loop->index < 5)
                        @if ($cast['profile_path'] != null)
                            <div class="mt-8">
                                ...
                                <div class="mt-2">
                                    <a href="#" class="text-lg mt-2 hover:text-gray:300"> {{ $cast['character'] }}
                                    </a>
                                    <div class="text-sm text-gray-400"> {{ $cast['original_name'] }} </div>
                                </div>
                            </div>
                        @endif
                    @endif
    ...
    <div class="show-images" x-data="{ isOpen: false, image: '' }">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold"> Tv Show Images </h2>
