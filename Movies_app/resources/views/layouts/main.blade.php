...
<body class="font-sans bg-zinc-900 text-white">
    <nav class="border-b border-gray-800">
        <div class="container mx-auto px-4 flex flex-col md:flex-row flex items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row item-center">
                ...
                <li class="md:ml-6 ml-3 md:mt-0">
                    <a class="hover:text-gray-300" href="{{ route('actors.index') }}"> Actors </a>
                </li>
                <li class="md:ml-6 ml-3 md:mt-0">
                    <a class="hover:text-gray-300" href="{{ route('mylist.index') }}"> My List </a>
                </li>
            </ul>
            ...
            <div class="flex flex-col md:flex-row items-center">
                <livewire:search-dropdown>
                    <div class="md:ml-4 mt-3 md:mt-0">
                        <a href="#">
                            <img class="rounded-full w-8 h-8" src="{{ asset('images/avatar.jpg') }}" alt="avatar" />
                        </a>
                    </div>
            </div>
        </div>
